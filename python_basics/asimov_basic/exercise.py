# Crie um código que  conta o número de vogais de um bloco de texto qualquer. O código deve desconsiderar letras maiúsculas/minúsculas, isto é, "a" e "A" contam da mesma forma.
...
vogais_a = texto_lowercase.count('a')
vogais_e = texto_lowercase.count('e')
vogais_i = texto_lowercase.count('i')
vogais_o = texto_lowercase.count('o')
vogais_u = texto_lowercase.count('u')

print(f"""
Quantidade de vogais que aparecem no texto
Letra a: {vogais_a}
Letra e: {vogais_e}
Letra i: {vogais_i}
Letra o: {vogais_o}
